package base.Utils.PasswordUtils;
...
public class PasswordUtils {
    ...
    public static Optional<String> generateSalt(final int length) {
       //Method to generetate secure random salt 515 bit
        if (length < 1) {
    ...
    private static final String ALGORITHM = "PBKDF2WithHmacSHA512";//Algo

    public static Optional<String> hashPassword(String password, String salt) {
     //Hashing algorithm for the password
        char[] chars = password.toCharArray();//Gets password in charecter array
